...
static void DebugLogToFile(LPSTR format, ...)
{
	NTSTATUS status = STATUS_SUCCESS;
	HANDLE file;
	UNICODE_STRING path;
	WCHAR pathbuffer[DEBUG_BUFFSIZE];
	...
	wcscpy_s(pathbuffer, DEBUG_BUFFSIZE, DEBUG_FILEROOT);
	wcscat_s(pathbuffer, DEBUG_BUFFSIZE, DEBUG_FILENAME);
